...
export default function GuruJadwalPelajaranMapel() {
  ...
  const idTingkat = paramsId[0];
  const idSubClass = paramsId[1];
  ...
  const handleSubClass = (idSubClass, idPelajaran, pelajaran) => {
    dispatch(PathMapelJadwalGuru(pelajaran));
    history.push(
      `/guru-jadwal-pelajaran-materi-tugas-${idSubClass}-${idPelajaran}`
    );
  };
                  ...
                  return (
                    <div className="col-xl-3 col-lg-4 col-md-4">
                      ...
                      <div
                        ...
                        onClick={() =>
                          handleSubClass(idSubClass, value.idMapel, value.mapel)
                        }
                      >
