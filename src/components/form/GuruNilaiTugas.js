...
export const FormGuruNilaiTugas = (props) => {
    ...
    useEffect(() => {
        axios.post(url_by_institute,
            {
                "processDefinitionId": "rolegurugeteditpenilaian:1:cfba1a86-5fdb-11ed-bb6a-a2fb3d782380",
    ...
    const _submitNilai = () => {
        ...
        if (checkDataFunc()) {
            axios
                .post(
                    url_by_institute, {
                    "processDefinitionId": "rolegurueditpenilaian:1:04771794-5fe0-11ed-bb6a-a2fb3d782380",
                    "returnVariables": true,
                    "variables": [
                        {
                            "name": "data",
