...
export default function DataKelasAdmin() {
      ...
      .then(function (response) {
        ...
        if (resCode == 200) {
          ...
          notification.error({
            message: "Error",
            description:
              "Gagal menambahkan data kelas, mohon cek kembali tabel excel anda.",
            placement: "top",
          });
        }
      });
      ...
      .then(function (response) {
        ...
        if (resCode == 200) {
          ...
          notification.error({
            message: "Error",
            description:
              "Gagal menambahkan data kelas, mohon cek kembali file excel anda.",
            placement: "top",
          });
        }
      });
  ...
  const _modalImportNew = () => {
    Modal.warning({
      title:
        "Jika anda memilih fitur ini, maka semua data kelas akan di replace dengan data excel yang anda impor.",
      width: "800px",
      content: (
        <div>
          ...
          variables: [
            {
              ...
              value: {
                ...
                select: ["x_academic_teachers.id as id_user", "users.name"],
                paginate: 1000,
                join: [
                  {
                    tbl_join: "users",
      ...
      },
      {
        ...
        render: (text, record) => (
          <Space size="middle">
            <EyeOutlined
              style={{ color: "black" }}
              onClick={() => viewDetailKelas(record)}
            />
            <EditOutlined
              style={{ color: "blue" }}
              onClick={() => viewEditKelas(record)}
            />
            <DeleteOutlined
              style={{ color: "red" }}
              onClick={() => deleteKelas(record)}
            />
            ...
            <Card className="card bg-lightblue border-0 mb-4 text-grey-900">
              <div className="row">
                <div className="col-lg-8 col-md-6 my-2">
                  ...
                  <Button
                    className="mr-4"
                    style={{ backgroundColor: "#5e7082", color: "white" }}
                    shape="round"
                    size="middle"
                  ...
                  <FilterAcademic
                    ...
                    getYear={(e) => {
                      ...
                      notification.info({
                        ...
                        description:
                          "Memilih Data Akademik tahun " + selectedYear,
                        placement: "top",
                      });
                    }}
