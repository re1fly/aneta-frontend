                ...
                {channelList.map((value, index) => (
                    <div className="col-xl-4 col-lg-6 col-md-6" key={index}>
                        <div className="card mb-4 d-block w-100 shadow-xss rounded-lg p-xxl-5 p-4 border-0 text-center">
                            ...
                            <h4 className="fw-700 font-xs mt-3">{value.title}</h4>
                            ...
                            <div className="mt-4 mx-auto">
                                ...
                                <div className="row ml-3">
                                    ...
                                    <div className="">
                                        <p className="font-xssss float-left lh-1">: {value.semester}</p>
                                    </div>
                                </div>
    ...
    const ViewDataKkm = () => {
        return (
            <div className="container px-3 py-4 ">
                    ...
                    <div className="row">
                        <div className="col-lg-8 col-md-6 my-2">
                            <Button className="mr-4" type="primary" shape="round" size='middle'
                                onClick={() => setIsViewDataPelajaranKelas(false)}>
                                Tambah Data
                            </Button>
                            <Filter title1="Tahun Akademik / Semester" title2="Kelas / Sub Kelas" />
                ...
                <div className="mt-4">
                    {grid ? <TabelDataPelajaranKelas /> : <CardDataPelajaranKelas />}
                </div>
            </div>
        )
    }
                                    ...
                                    <form id="teacher_form"
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    >
                                                        <option value="" selected disabled>
                                                            Pilih Kelas / Sub Kelas
                                                        </option>
                                                        <option value="Kelas 1/A">
                                                            Kelas 1/A
                                                        </option>
                                                        <option value="Kelas 1/B">
                                                            kelas 1/B
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div className="col-lg-6 mb-3">
                                                <div className="form-group">
                                                    ...
                                                    >
                                                        ...
                                                        <option value="2022 / Ganjil">
                                                            2022 / Ganjil
                                                        </option>
                                                        <option value="2022 / Genap">
                                                            2022 / Genap
                                                        </option>
                                                    </select>
                                                </div>
                                        ...
                                        <div className="row">
                                            <div className="col-lg-12">
                                                ...
                                                <a
                                                    onClick={() => setIsViewDataPelajaranKelas(true)}
        ...
        <Fragment>
            <div className="main-wrapper">
                ...
                <div className="main-content">
                    <Appheader />
                    {isViewDataPelajaranKelas ? <ViewDataKkm /> : <TambahDataKkm />}
                    <Adminfooter />
                </div>
            </div>
        </Fragment>
