...
function GuruKalenderTugas() {
    ...
    // const dataTugas = location.state.dataTugas
                ...
                <div className="row mb-3">
                    <div className="col-lg-12">
                        <PageHeader
                            ...
                            title={`Jadwal Pelajaran Kalender / Materi dan Tugas / Kelas ${dataTugas.subKelas} / ${dataTugas.namaPelajaran} / Tugas / ${dataTugas.namaMateri}`}
                        />
                    </div>
                </div>
...
export default GuruKalenderTugas;