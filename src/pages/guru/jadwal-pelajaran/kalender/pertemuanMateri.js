...
function GuruKalenderMateri() {
    ...
    const dataMateri = useSelector((state) => state.dataPathKalenderGuru.allPath)
                ...
                <div className="row mb-3">
                    <div className="col-lg-12">
                        <PageHeader
                            ...
                            title={`Jadwal Pelajaran Kalender / Materi dan Tugas / Kelas ${dataMateri.subKelas} / ${dataMateri.namaPelajaran} / Materi / ${dataMateri.namaMateri}`}
                        />
                    </div>
                </div>
...
export default GuruKalenderMateri;