    ...
    return (
      ...
      >
        <div
          ...
          href="/admin"
        >
          <span className="d-inline-block fredoka-font ls-3 fw-600 text-white font-xl logo-text mb-0 text-capitalize lh-1">
            Aneta.
          </span>
        ...
        <li className="nav-item">
          <NavLink className="navi-link" to="/admin-beranda">
            <i className="feather-home mr-2"></i>
            <span>Beranda</span>
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="navi-link" to="/admin-profil-sekolah">
            <i className="feather-globe mr-2"></i>
            <span>Profil Sekolah</span>
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="navi-link" to="/admin-data-guru">
            <i className="feather-book mr-2"></i>
            <span>Data Guru</span>
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="navi-link" to="/admin-data-siswa">
            <i className="feather-book mr-2"></i>
            <span>Data Siswa</span>
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="navi-link" to="/admin-data-kelas">
            <i className="feather-user mr-2"></i>
            <span>Datas Kelas</span>
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="navi-link" to="/admin-jadwal-pelajaran">
            <i className="feather-calendar mr-2"></i>
            <span>Jadwal Pelajaran</span>
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="navi-link" to="/admin-data-pelajaran">
            <i className="feather-book mr-2"></i>
            <span>Data Pelajaran</span>
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="navi-link" to="/admin-kompetensi">
            <i className="feather-clipboard mr-2"></i>
        ...
        <li className="nav-item">
          <NavLink className="navi-link" to="/siswa-beranda">
            <i className="feather-home mr-2"></i>
            <span>Beranda</span>
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="navi-link" to="/siswa-kelas-materi">
            <i className="feather-globe mr-2"></i>
            <span>Kelas Saya</span>
          </NavLink>
        </li>

        <div className="sidebar-heading">Orang Tua</div>

        <li className="nav-item">
          <NavLink className="navi-link" to="/orangtua-beranda">
            <i className="feather-home mr-2"></i>
            <span>Beranda</span>
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink className="navi-link" to="/orangtua-data-anak">
            <i className="feather-home mr-2"></i>
            <span>Data Anak</span>
          </NavLink>
        </li>
