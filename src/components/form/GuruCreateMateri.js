...
export const FormCreateMateri = (props) => {
  ...
  useEffect(() => {
    ...
    if (idTingkatKelas != "") {
      dispatch(GetSubKelas(idTingkatKelas, academic, userId));
    }
    if (idSubKelas != "") {
      dispatch(GetPelajaran(idTingkatKelas, idSubKelas, academic, userId));
    }
    if (idPelajaran != "") {
                    ...
                    <div className="col-lg-6 mb-3">
                      <div className="form-group">
                        ...
                        >
                          <option
                            value=""
                            selected={idTingkatKelas == "" ? false : true}
                          >
                            {props.tingkatKelas == undefined
                              ? "Pilih Tingkat Kelas"
                              : props.tingkatKelas}
                          </option>
