        ...
        {channelList.map((value, index) => (
          <div className="col-xl-4 col-lg-6 col-md-6" key={index}>
            <div className="card mb-4 d-block w-100 shadow-xss rounded-lg p-xxl-5 p-4 border-0 text-center">
              ...
              {value.tag1 ? (
                <span className="font-xsssss fw-700 pl-3 pr-3 lh-32 text-uppercase rounded-xxl ls-2 alert-success d-inline-block text-success mb-1 mr-1 mt-2">
                  {value.tag1}
                </span>
              ) : (
                ""
    ...
    const data_sampel1 = () => {
      ...
      dataKirimNilai?.siswa?.map((data, index) => {
        tmp.push({
          ...
          // pengetahuan
          nilaiPengetahuan:
            dataKirimNilai?.siswa[index]?.data_nilai[0].given_value,
          predikatPengetahuan:
            dataKirimNilai?.siswa[index]?.data_nilai[0].predikat,
          // keterampilan
          nilaiKeterampilan:
            dataKirimNilai?.siswa[index]?.data_nilai[1].given_value,
          predikatKeterampilan:
            dataKirimNilai?.siswa[index]?.data_nilai[1].predikat,
          // spiritual
          predikatSpiritual:
            dataKirimNilai?.siswa[index]?.data_nilai[2].predikat,
          // sikap
        ...
        {dataKirimNilai == null ? (
          ...
          <>
            <div className="mt-4 bg-grey">
              <p className="font-xssss strong text-black pl-4 mb-0">
                Tabel Interval Predikat -{" "}
                {dataKirimNilai?.interval_predikat?.nama_matpel}
              </p>
            </div>
            <Table
              className="mt-0 py-8"
            ...
            >
              ...
              <ColumnGroup title="Pengetahuan">
                ...
                <Column
                  align="center"
                  title="Predikat"
                  dataIndex="predikatPengetahuan"
                  key="predikatPengetahuan"
                />
              </ColumnGroup>
              <ColumnGroup title="Keterampilan">
                <Column
                  ...
                  key="nilaiKeterampilan"
                />
                <Column
                  align="center"
                  title="Predikat"
                  dataIndex="predikatKeterampilan"
                  key="predikatKeterampilan"
                />
              </ColumnGroup>
