...
const priceList = [
    ...
    },
    {
        ...
        price: '99',
        title: 'GOLD',
        des: 'Jumlah Siswa 300-500',
        status: 'alert-success text-success',
        statusCheck: true
        // statusText: 'ti-check font-xssss mr-2 btn-round-xs ${value.status}'
    },
    {
        color: 'border-info',
        price: '19',
        title: 'DIAMOND',
        des: 'Jumlah Siswa 500+',
        status: 'alert-success text-success',
        statusCheck: true
    },
];
            ...
            <Fragment>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-8 offset-lg-2 text-center">
                                ...
                                <p className="font-xsss text-grey-600 fw-500 d-block mt-2 pl-lg-5 pr-lg-5 lh-30">
                                    Terdapat biaya berlangganan untuk layanan yang kami berikan sebagai berikut.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="price-wrap bg-greyblue pb-lg--7 pb-5 ">
                    <div className="container">
                                ...
                                <div className="row">
                                    {priceList.map((value, index) => (
                                        <div className="col-lg-4" key={index}>
                                            <div
                                                className="card border-0 mb-4 bg-white shadow-xss shadow-xss rounded-lg">
                                                <div
                                                ...
                                                >
                                                    ...
                                                    {/*  </span>*/}
                                                    {/*</h1>*/}
                                                    <h1 className="display1-size fw-700">
                                                        {value.title}
                                                    </h1>
                                                    ...
                                                    {
                                                        value.statusCheck == true ?
                                                            <h4 className=" font-xssss fw-600 text-grey-500 mb-4">
                                                                <i
                                                                    className={`ti-check font-xssss mr-2 p01 btn-round-xs alert-success text-success`}
                                                                ></i>
                                                                Teknisi Support
                                                            </h4> :
                                                            <h4 className=" font-xssss fw-600 text-grey-500 mb-4">
                                                                <i
                                                                    className={`ti-close font-xssss mr-2 p01 btn-round-xs alert-danger text-danger`}
                                                                ></i>
                                                                Teknisi Support
                                                            </h4>
                                                    }
                                                    ...
                                                    <a
                                                        href="/register"
                                                        className="btn btn-block border-0 w-100 btn-register p-3 text-white fw-600 rounded-lg d-inline-block font-xssss btn-light mt-3"
                                                    >
                                                        Daftar Segera
                                                    </a>
                                                </div>
                        ...
                        <div className="col-lg-8 offset-lg-2 text-center">
                            <h2 className="text-grey-800 fw-700 display4-md-size mb-3 mt-5 ls-0">
