                        ...
                        <div className="col-xl-3 col-lg-4 col-md-4">
                            ...
                            >
                                <div
                                    ...
                                    <h2 className="ml-auto mr-auto p-3 mt-3 font-weight-bold">{value.title}</h2>
                                </div>
                            </Link>
                        </div>
                    )
...
export default GuruInputDataNilai;