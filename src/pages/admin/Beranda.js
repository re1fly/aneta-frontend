      ...
      axios
        ...
        .then(function (response) {
          ...
          if (academic.status == false) {
            const btn = (
              <Button
                href="/admin-list-tahun-akademik"
                type="primary"
                shape="round"
                size="middle"
              >
            ...
            notification.info({
              message: "Warning !",
              description:
                "Mohon isi tahun akademik terlebih dahulu dengan klik button disini",
              btn,
              duration: null,
              placement: "top",
            });
  ...
  const getDataNpsn = () => {
    ...
    axios
      .post(
        ...
        {
          processDefinitionId:
            "getwherenojoinfirst:1:84d5c713-2cc7-11ed-aacc-9a44706f3589",
          returnVariables: true,
          variables: [
            {
              name: "global_get_where",
      ...
      .then(function (response) {
        ...
        if (resCode == 200) {
          ...
          notification.info({
            ...
            description:
              "Mohon masukkan NPSN yang sudah terdaftar di KEMENDIKBUD.",
            placement: "top",
          });
        } else {
          notification.error({
      ...
      .then(function (response) {
        ...
        if (response.data.variables[6].value == 422) {
          notification.error({
            message: "Error",
            description:
              "Harap isi semua data dan pastikan NPSN belum pernah terdaftar",
            placement: "top",
          });
      ...
      return (
        <div className="row">
          <div className="col-lg-6">
            <div className="form-group">
              <label className="mont-font fw-600 font-xsss">NPSN</label>
              {/*<input*/}
              {/*    name="npsn_institute"*/}
              {/*    type="text"*/}
              {/*    className="form-control"*/}
            ...
            <p>
              Sekolah Anda :{" "}
              <a className="text-info" onClick={() => setSubmittedNpsn(true)}>
                {dataSearch[0]?.npsn} - {dataSearch[0]?.nama}
              </a>
            </p>
          </div>
          {/*<div className="col-lg-6">*/}
    ...
    const FormDetail = () => (
      <>
        ...
        <div className="row">
          ...
          <div className="col-lg-6 mb-3">
            <div className="form-group">
              <label className="mont-font fw-600 font-xsss">Fax</label>
              <input
                type="number"
                name="fax_institute"
                className="form-control"
    ...
    return (
      <>
        ...
        <p className="text-danger font-weight-bold">
          Mohon isi Institute dan PIC form sebelum dapat mengakses fitur
          Dashboard.
        </p>
          ...
          <div className="container px-3 py-4">
            ...
            <div className="row">
              ...
              <div className="col-lg-12 d-flex mb-4">
                <h2 className="text-grey-900 ml-1 font-md fw-700">
                  Statistik Sekolah
                </h2>
                <select
