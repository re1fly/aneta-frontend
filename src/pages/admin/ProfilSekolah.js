...
function ProfilSekolah() {
          ...
          variables: [
            {
              ...
              value: {
                ...
                select: [
                  "m_institutes.id as id_institute",
                  "m_institutes.name",
  ...
  const _submitProfile = (e) => {
    ...
    notification.open({
      message: "Success",
      description: "Profil Sekolah berhasil diubah",
      ...
      <div className="main-wrapper">
        ...
        <div className="main-content">
          ...
          <div className="container px-3 py-4">
            ...
            <form onSubmit={editInstitute} method="POST">
              <div className="row">
              ...
              <div className="row">
                ...
                <div className="col-lg-6 mb-3">
                  <div className="form-group">
                    ...
                    >
                      <option
                        value={dataSekolah.sub_district_id}
                        selected
                        disabled
                        hidden
                      >
