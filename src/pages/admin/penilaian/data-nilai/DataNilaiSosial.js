        ...
        axios
            ...
            .then(function (response) {
                ...
                if (resCode === true) {
                    notification.success({
                        message: "Sukses",
                        description: "Data Penilaian Sosial berhasil di input",
                        placement: 'top'
                    })
                } else {
                    notification.info({
                                    ...
                                    <div className="table-custom">
                                        <table className="table table-bordered">
                                            ...
                                            <tr className='bg-current text-light'>
                                                ...
                                                <th scope="col" colSpan={jmlKompetensi == null ? 1 : jmlKompetensi.length } className='text-center'>Kompetensi Dasar / Indikator Sikap Sosial</th>
                                            </tr>
                                            <tr className='bg-current text-light'>
                                                {jmlKompetensi == null ? <th scope="col">Data Kosong</th> :
                                                    jmlKompetensi.map((item, index) => (
                                                        <th scope="col"
                                                            className='text-center text-capitalize'>
                                                            {item.competence_desc}
                                                        </th>
                                                    ))}
                                            </tr>
                                            </thead>
