                                ...
                                <div className="table-custom">
                                    <table className="table table-bordered">
                                        ...
                                        <tr style={{borderRightStyle:'hidden'}}>
                                            <th scope="row" style={{borderLeftStyle:'hidden', borderRightStyle:'hidden', backgroundColor: 'white', color: 'black'}}>
                                                <h3><b>Kompetensi Dasar</b></h3>
                                            </th>
                                        </tr>
                                        <tr style={{borderStyle:'hidden'}}>
                                            <th scope="row" style={{borderRightStyle: 'hidden', backgroundColor: 'white', color: 'black'}}>
