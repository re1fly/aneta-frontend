              ...
              {kelasSiswa.map((value, index) => (
                ...
                <div className="col-lg-4">
                  ...
                  >
                    ...
                    <h1 className="text-center display4-size font-weight-bold mb-1">
                      {" "}
                      {value.kelas} / {value.subKelas}
                    </h1>
                    <h4 className="text-center font-xss">
                      Semester : {value.semester}
                    </h4>
                    <h3 className="text-center font-xss mb-0">
                      Tahun Akademik : {value.tahunAkademik}
                    </h3>
                  </div>
                </div>
              ))}
                    ...
                    <div className="row">
                      ...
                      <div className="col-8">
                        ...
                        <div className="row">
                          ...
                          <p className="col-lg-7 strong mb-0">
                            : {value.date_of_birth}
                          </p>
                        </div>
                        <div className="row">
