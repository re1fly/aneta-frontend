...
function DataSiswaAdmin() {
    ...
    useEffect(() => {
        axios.post(BASE_URL,
            ...
            .then(function (response) {
                const responseData = JSON.parse(response.data.variables[3].value);
                const dataOrangtua = responseData.data.data;
                setDataOrtu(dataOrangtua);
            });
    }, [])
    ...
    const createSiswa = (e) => {
        ...
        axios.post(BASE_URL, {
                "processDefinitionId": "d086ebb2-e885-11ec-a658-66fc627bf211",
                "returnVariables": true,
                "variables": [
                    {
                        "name": "validasi",
            ...
            if (response.data.variables[9].value == 200) {
                if (response.data.variables[11].value == 404) {
                    setIsViewSiswa(true)
